# Task 1 - Shows workspace Directory
...
# Task 2 - Reads Data from csv file or can pick file from explorer
...
#sd
#apply can be used on matrices and data frames
# 2 = columns, 1=rows, sd = std dev function
apply(z,2,sd)
