...
###Plot of Beta Density with shape1 = 1 and shape2 = 2 and show probability of 0:1
curve(
...
###Plot of Beta Density with shape1 = 5 and shape2 = 10 and show probability of 0:1
curve(
...
###Plot of Beta Density with shape1 = 10 and shape2 = 5 and show probability of 0:1
curve(
